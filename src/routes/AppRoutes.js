...
const AboutTab = lazy(() => import("../pages/Profile/tab/AboutTab"));
const HomeTab = lazy(() => import("../pages/Profile/tab/HomeTab"));
const ListsTab = lazy(() => import("../pages/Profile/tab/ListsTab"));
